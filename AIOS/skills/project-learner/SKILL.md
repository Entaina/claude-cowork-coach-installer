...
description: >-
  Lee el log del día y detecta movimiento del frente de ejecución — proyectos
  nuevos que asoman en las conversaciones, áreas de responsabilidad sin
  archivo, avances y decisiones de los existentes, estados que ya no cuadran
  con la realidad. Todo lo convierte en propuestas (crear, actualizar, cambiar
  estado) que esperan la firma del usuario; las aprobadas se aplican vía
  project-manager. No aplica nada por su cuenta. Corre cada noche en la tarea
  programada del Sistema Proyectos y Áreas, tras la nocturna del Learning
  System. Se activa con frases como: "propuestas de proyectos", "qué proyectos
  has detectado", "project learner".
metadata:
