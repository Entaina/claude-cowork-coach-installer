...
1. Copia toda la estructura del repositorio
   ...
   INSTALL.md, UPDATE.md, CHANGELOG.md y cualquier archivo de git (.git,
   .gitkeep, .gitignore...), que no se copian. Las carpetas vacías del
...
3. Aplica solo los cambios que me falten, de forma aditiva. No toques ME.md,
   projects/, areas/, knowledge/ ni episodic/, y no borres nada que yo haya
   creado. Al terminar, actualiza AIOS/VERSION.md y enséñame el resumen.
```
